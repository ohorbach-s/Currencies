...
+ (void)asynchronousRequestWithcompletionHandler:
            (void (^)(NSMutableDictionary *))
        completionHandler { // implementing the asynchronous request for the manual update
...
+ (NSMutableDictionary *)synchronousRequest { // implementing the synchronous request for the background update
